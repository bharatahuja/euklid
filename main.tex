...
\begin{frame}
	...
	Ohne Einschr\"ankung nehmen wir an, dass $a > b$ und f\"uhren nur eine Iteration des Algorithmus aus.\\ Am Anfang ist die Differenz der Zahlen $a-b$. Nach dem Subtraktions- und Reduktionsschritt ist die neue Differenz betragsm\"assig $|(a-b)-b|=|a-2b|$. \\
Mit der Dreiecksungleichung	bekommt man $|a-2b| \leq |a-b| + |b|$. Da $b\geq 1$, folgt $|a-2b| < |a-b|$
	
	\begin{quote}D.h. die Differenz wird in jedem Schritt betragsm\"assig kleiner.\end{quote} Da der Betrag der Differenz nach unten beschr\"ankt ist und streng monoton fallend ist, muss der Algorithmus nach h\"ochstens $|a-b|$ Iterationen terminieren.
\end{frame}

\begin{frame}
	\frametitle{\textsc{LangsamEuklid}}
	\framesubtitle{Korrektheit}
	Ohne Einschr\"ankung sei $a>b$.\\
	Wenn eine Zahl $a$ und $b$ teilt, dann teilt sie auch $a-b$. Umgekehrt teilt auch jede Zahl, die $a-b$ und $b$ teilt, auch die Summe $(a-b)+b=a$. \\D.h. die Menge der gemeinsamen Teiler von $a$ und $b$ ist gleich der Menge der gemeinsamen Teiler von $a-b$ und $b$. \\Da die Mengen gleich sind, haben sie auch das gleiche Minimum.\\\begin{quote}
